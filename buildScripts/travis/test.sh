...
export LANG=en_US.UTF-8 && $EXECUTOR bash -lixc "curl --output tests_qrs.zip https://dl.trikset.com/edu/.solutions20200701/test.7z && 7z x -mcu=1251 tests_qrs.zip && ls testing"
